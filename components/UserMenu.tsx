      ...
      >
        ...
        <div className="flex-none flex items-center justify-between px-1 mb-2">
           <div className="h-4 flex items-center">
             {userData?.className && (
                <span className="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider pl-2">
                  {userData.className}
                </span>
             )}
           </div>
           <button 
             onClick={onClose}
             className="p-1 rounded-full text-gray-400 hover:text-gray-600 dark:text-gray-500 dark:hover:text-gray-300 transition-colors bg-white/50 dark:bg-black/20"
           >
